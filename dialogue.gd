...
var dialogue_dict = { #character, dialogue, time, expression, anim
	...
	"start" : [
		["npc2", "Commander! You made it!", 3.0, "Surprise", "SmallTalk"],
		["npc3", "Not Commander for long...", 2.0 , "Evil", "Idle"],
		["npc2", "I'm so glad you could join us here for a round of Liar's Dice!", 3.0, "neutral", "OneHandTalk"],
		["npc1", "Well... Imperial Dice.", 2.0, "Talk", "Idle"],
		["npc1", "The rules are wrong.", 2.0, "Talk2", "SmallTalk"],
		["npc1", "", 0.5, "Neutral", "Idle"], 
		["npc2", "Yes. No wilds and...", 2.0, "Surprise", "Idle"],
		["npc3", "Everyone gets a chance to call!", 3.0, "Talk", "Attention"],
		["npc3", "", 0.5, "Neutral", "Idle"], 
		["npc2", "Precisely. Keeps the game more fun. This way you...", 2.0, "neutral", "Thinky"],
		["npc1", "Can't trust anyone.", 3.0, "AngryTalk", "OneHandTalk"],
		["npc1", "", 0.5, "Neutral", "Idle"], 
		["player", "", 3.0, "neutral", "Idle"],
		["npc2", "Yes, well. Let's get to it shall we?", 3.0, "Surprise", "Idle"],
		["npc3", "Liar's dice, woohoo!", 1.0, "Evil", "Idle"],
		["npc1", "", 0.5, "Neutral", "Idle"], 
		["npc2", "", 0.5, "Neutral", "Idle"], 
		["npc3", "", 0.5, "Neutral", "Idle"], 
		],
	"win" : [
